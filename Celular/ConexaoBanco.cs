...
{
    public static class ConexaoBanco //Unica 
    {
        ...
        /*Para qualquer serviço de BD, temos que inserir uma String de conecção*/
        ...
        public static void Executar(string sql) //método Executar chama método Conectar
        {
            try
            {
                Conectar();
